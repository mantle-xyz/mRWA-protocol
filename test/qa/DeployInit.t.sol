...
contract DeployInitQATest is Test {
    ...
    function test_DuplicateInit_Prevention() public {
        ...
        _step("[Step 4] Deploy and initialize a StrategyController, then try re-init");
        ...
        StrategyController sc = StrategyController(address(new ERC1967Proxy(
            address(scImpl),
    ...
    function test_AccountantInit_RejectInvalid() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Accountant.InvalidFeeRate.selector, uint256(tooHighFee)));
    ...
    function test_AccountantRolesCheck() public {
        ...
        assertTrue(acct.hasRole(acct.EXECUTOR_ROLE(), admin));
